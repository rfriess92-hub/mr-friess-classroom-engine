...
export const TEACHING_MODE_DEFAULTS = {
  standard: {
    default_output_types: ['teacher_guide', 'slides', 'worksheet', 'pacing_guide', 'exit_ticket'],
    prompt_notes: null,
  },
  hands_on: {
    default_output_types: ['teacher_guide', 'task_sheet', 'station_cards', 'pacing_guide', 'exit_ticket'],
  ...
  sub_friendly: {
    default_output_types: ['teacher_guide', 'slides', 'worksheet', 'sub_plan', 'pacing_guide', 'exit_ticket'],
  ...
  quiet_writing: {
    default_output_types: ['teacher_guide', 'task_sheet', 'final_response_sheet', 'pacing_guide'],
