...
test('response-pattern parity proof fixture stays schema- and route-valid', () => {
  const pkg = loadFixture('fixtures/tests/response-pattern-parity.single-period-full.json')
  ...
  assert.equal(routes[0].output_type, 'worksheet')
